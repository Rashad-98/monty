...
/**
 * struct resources_s - file handle and current line in file
 * @file_handle: stream associated with file
 * @line: current line in file
 *
 * Description: resources that should be freed at befor exiting
 */
...
int check_instruction(int insc, instruction_t *instructions, char *);
void free_stack(stack_t *);
int check_push_arg(char *);
#endif
